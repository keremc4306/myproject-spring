package com.myproject.spring.loginregister.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${myproject.app.jwtSecret}")
    private String jwtSecret;
    
    @Value("${myproject.app.jwtExpirationMs}")
    private int jwtExpirationMs;
    
    @Value("${myproject.app.jwtCookieName}")
